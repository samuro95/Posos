...
def random_walk(graph, node, max_walk_length):
    '''
    return a random walk over a graph of words of len max_walk_length
    '''
    walk = [node]
...
def augment_data_random_walk(train_sent, y_train, window_size = 3, proportion = 2, maxlen = 50) :
    '''
    data augmentation thanks to random walks over graphs of words created from all the sentences in a class
    '''
